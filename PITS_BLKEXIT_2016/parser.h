...
//int parse_input(char *str, int i);
//int parse_input(char *str, int i, char *types[BUFFLEN], int limits[BUFFLEN]);
int parse_input(char *str, int i, char *types[BUFFLEN], int limits[BUFFLEN], int precisions[BUFFLEN]);
//int read_specs(char *cfg_path);
//int read_specs(char *cfg_path, int cols);
